	...
	var menuOptions = ['producto','ingproducto','proveedores','cajarosa','reportes','cobrosmarca','pagosMes','marcacobros','historialrecibos','historialrecibos','respaldarData','clientes','config'];
    ...
    $(document).on('click', '#promociones', function () {
		...
		setActive('config');
		$('#maincontroller').load("../secciones/config.php");
		$("#nombreseccion").text("Control de configuraciones");
	})
