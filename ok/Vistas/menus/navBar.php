  ...
  <div class="br-header-right">
    <nav class="nav">
      <span class="content-desktop" id="btn1caja">
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#cajaModal"
          id="modal1">Abrir/Cerrar caja</button>
      </span>
      <div>
        <spam>______</spam>
      </div>
      <span class="content-desktop" id="btn2sal">
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#salidasModal"
          id="modal1">Salidas de caja</button>
      </span>
...
<div class="modal fade" id="cajaModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
...
<!-- Modal -->
<div class="modal fade" id="salidasModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
